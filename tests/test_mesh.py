...
from fea_toolkit.model.sap_data import AreaElement, AreaMesh, Node
...
def test_flatness_planar_rhomboid():
    ...
    from fea_toolkit.mesh.checks import flatness
    from fea_toolkit.model.sap_data import AreaElement, Node
    ...
    fl = flatness(areas, nodes)
    assert fl["R"] == pytest.approx(0.0, abs=1e-12), (
        f"planar rhomboid should be flat, got {fl['R']}"
    )
...
class TestMeshRemesh:
    ...
    def test_remesh_basic_quad(self, quad_area, quad_nodes):
        ...
        areas, assign, _nodes, _ntag = remesh_areas(
            quad_area,
            {},
            quad_nodes,
            mesh,
    ...
    def test_remesh_no_mesh_skipped(self, quad_area, quad_nodes):
        ...
        areas, _assign, _nodes, _ntag = remesh_areas(
            quad_area,
            {},
            quad_nodes,
            mesh,
