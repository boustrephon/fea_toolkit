...
class TestSectionPromotion:
    ...
    def test_admin_section_promotion(self):
        """Parse Project B S2K and verify all RC sections are promoted."""
        from fea_toolkit.io.s2k_parser import SAP2000Parser
        from fea_toolkit.model.sap_data import (
            ConcreteRectangularSection, RectangularSection, ISection,
        )

        s2k_path = ("/Users/<user>/Library/Mobile Documents/"
                    "com~apple~CloudDocs/Work/Projects/<private_project>/"
                    "<private_project>/Project_B/"
                    "project_b.s2k")
