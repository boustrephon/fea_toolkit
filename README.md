...
2. **ETABS `.E2K` / `.$ET` input**  
   - 🚧 Placeholder — the text-parser path reads SAP2000 text exports
     (`.s2k` / `.$2k`) only; `SAP2000Parser.from_json()` reads JSON caches.
     No ETABS-specific handling exists — see `io/s2k_parser.py`.  
