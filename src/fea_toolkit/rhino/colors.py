...
def _ensure_color():
    ...
    # Module-level cache; intentional global assignment for the lazy-import
    # sentinel pattern (Rhino/IronPython has no importlib).
...
def color_from_name(color_value: t.Any):
    ...
    elif color_lower in fallback_names:
