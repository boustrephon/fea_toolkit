...
Usage::
    ...
    log = ModelLog("project_b", output_dir="output")
    log.add_diagnostic(
    ...
    log.save()                          # → output/project_b.log.json
    log.to_script()                     # → output/project_b.log.py

Viewing diagnostics from a saved log::

    from fea_toolkit.io.log import load_log
    log = load_log("output/project_b.log.json")
    log.print_summary()
...
diagnostics — run it standalone::
    ...
    python "output/project_b.log.py"
"""
