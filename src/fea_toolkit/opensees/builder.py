...
class OpenSeesBuilder:
    ...
    def export_model_to_tcl(
        ...
        Delegates to :func:`export_model_to_tcl`.
        """
        export_model_to_tcl(
    ...
    def _tcl_materials_and_sections(
        ...
        Delegates to :func:`tcl_materials_and_sections`.
        """
        return tcl_materials_and_sections(model_data, config)
    ...
    def pushover_tcl(
        *,
        ...
        Delegates to :func:`pushover_tcl`.
        """
        return pushover_tcl(
            ...
            gravity_pattern=gravity_pattern,
            adaptive=adaptive,
        )
