...
def _build_and_constrain(md: SAPModelData) -> AnalysisBuilder:
    ...
    raw_edges = find_constraint_edges(
        b.mesh_model.area_elements, b.mesh_model.area_assignments, b.mesh_model.nodes,
...
def _build_cache_data(modal_result: Dict[str, Any],
    ...
    node_tags = sorted(modal_result.get("builder", object).mesh_model.nodes
        ...
        if b is not None and shapes is not None:
            try:
                ...
                visualize_mode_shapes(
                    ...
                    scale=50.0, out_dir="examples/output",
                    save_gif=save_gif,
                )
            except Exception as exc:
