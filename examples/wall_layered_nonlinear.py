...
+------------+-------------+--------------------------------------+
| 3 (core)   | 0.16 m      | ConcreteS (concrete, core)               |
+------------+-------------+--------------------------------------+
...
values from ``project_b_pushover_v4.py``; author in Pa and let
...
2. Fill in the ``nd_materials`` / ``shell_layers`` config below (or
   replace with the working block from ``project_b_pushover_v4.py``) and a
