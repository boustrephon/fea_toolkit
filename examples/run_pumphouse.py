#!/usr/bin/env python
"""Example: Load the Project A model and run a static analysis.

Usage:

    python examples/run_project_a.py
"""
...
def main():
    s2k_path = Path(
        ...
        "Work/Projects/<private_project>/Project A/BPPS_pump_house.$2k"
    )
    ...
    try:
        ...
        if fig_n:
            fig_n.savefig('project_a_axial.png', dpi=150)
            print("  Saved → project_a_axial.png")
        ...
        if fig_vx:
            fig_vx.savefig('project_a_shear.png', dpi=150)
            print("  Saved → project_a_shear.png")
        ...
        if fig_m:
            fig_m.savefig('project_a_moment_2d.png', dpi=150)
            print("  Saved → project_a_moment_2d.png")
    ...
    try:
        ...
        if plotter_tube is not None:
            plotter_tube.screenshot('project_a_moment_3d.png')
            print("  Saved → project_a_moment_3d.png")
    except Exception as e:
