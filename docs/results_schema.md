...
7. Keep private Project A files under [local/<private_project>/Project A](../local/<private_project>/Project A) as thin wrappers that call the shared report engine.
...
4. **Private local wrappers** — [local/<private_project>/Project A](../local/<private_project>/Project A)
