...
"Highlight a constraint group (red)"  → plot_mesh(builder, node_colors={jid: '#ff2d2d'})  # jids ← md.constraint_assignments
```
...
the real Project B shear-wall wall type (`ShellNLDKGQ` + 5-layer
